//
// UE1's own copy of the touch control layout (was sharing
// Clibs_OpenTouch/alpha/touch_interface.cpp with the other Alpha Touch
// engines in Phase 1; the PERFECT_DARK/ROTTEXPR branches below never applied
// to this engine and have been dropped).
//
...
void TouchInterface::createControls(std::string filesPath)
{
    ...
    gamepadUtils->addCell(0, 1, "notebook", PORT_ACT_DATAPAD);
